...
{
    public class ExtensibleFunctionCall : Expression
    {
        public ExtensibleFunctionCall(Expression[] args, TypeNode dataType, StandardLibraryFunction opCode, string exprStr)
        ...
        public override void GenerateLoad(List<int> trueBranch, List<int> falseBranch)
        {
            ...
            int inputCount = this.arguments.Count();
            this.StoreInstruction(VirtualMachineInstruction.ICONST, inputCount);
