...
{
    public class CharConstant : Constant<byte>
    {
        public CharConstant(byte value) : base(TypeNode.Char, value, value.ToString())
        {
            this.isSmallConstant = value == 0 || value == 1;
        }

        public CharConstant(byte value, string valueStr)
            : base(TypeNode.SInt, value, valueStr)
        {
            this.isSmallConstant = value == 0 || value == 1;
        }

        public CharConstant(byte value, TypeNode dataType, string valueStr)
