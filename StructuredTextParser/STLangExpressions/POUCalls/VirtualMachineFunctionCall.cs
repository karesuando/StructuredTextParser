...
{
    public class VirtualMachineFunctionCall : Expression
    {
        public VirtualMachineFunctionCall(Expression[] args, TypeNode dataType, VirtualMachineInstruction opCode, string exprStr)
